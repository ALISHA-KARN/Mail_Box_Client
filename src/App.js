...
import {
  SetEmailData,
  SetReceivedEmailData,
} from "./Components/Redux/Slices/StoreEmail";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/emailcompose"
            element={
              portal ? <PrivateRoutes component={Portal} alt={Login} /> : null
            }
          />
          <Route
            path="/email"
            element={
              portal ? (
                <PrivateRoutes component={EmailComposer} alt={Login} />
              ) : null
            }
          />
          <Route
            path="/sendemail"
            element={<PrivateRoutes component={SendEmail} alt={Login} />}
          />
          <Route
            path="/reademail"
            element={<PrivateRoutes component={ReadEmail} alt={Login} />}
          />
          <Route
            path="/receivedemails"
            element={<PrivateRoutes component={ReceivedEmail} alt={Login} />}
          />
          <Route
            path="/emailbody"
            element={<PrivateRoutes component={EmailBody} alt={Login} />}
          />
        </Routes>
      </BrowserRouter>
    </div>
